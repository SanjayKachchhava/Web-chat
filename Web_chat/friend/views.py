...
def friend_list_view(request,*args,**kwargs):
	...
	if user.is_authenticated:
		...
		if user_id:
			...
			friends = [] # [(account1,True),(account2,False),(account3,True)....]
...
def cancel_friend_request(request,*args,**kwargs):
	...
	if request.method == "POST" and user.is_authenticated:
		...
		if user_id:
			...
			# There should only ever be a single active friend request at any given time. cancel then all just in case.
